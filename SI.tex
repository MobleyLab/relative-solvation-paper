...
outlined in eq.\,\eqref{eq:Sire-softcore} for Sire, 
eq.\,\eqref{eq:AMBER-softcore} for AMBER, eq.\,\eqref{eq:GROMACS-softcore} for 
GROMACS and eq.\,\eqref{eq:CHARMM-softcore} for CHARMM.
