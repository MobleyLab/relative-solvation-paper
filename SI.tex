  ...
  \begin{minipage}{\linewidth}
    ...
    \makebox[\textwidth][c]{%
      \begin{tabular}{llrrrrrrrr}
        ...
        \midrule
2-methylindole  & methane      &  4.832 & 0.022 &  3.484 & 0.009 &  19.419 & 0.007 &  11.989 & 0.001 \\
methane        & 2-methyindole & -4.900 & 0.017 & -3.185 & 0.011 & -19.412 & 0.009 & -11.989 & 0.001 \\
        \bottomrule
      \end{tabular}
    }
  \end{minipage}
