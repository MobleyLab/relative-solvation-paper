...
particular implementation can not be explained at the moment.

\begin{table}
  \begin{minipage}{\linewidth}
    \caption{Free energies of hydration for the 2--cyclopentanylindole to 7--cyclopentanylindole case with three different protocols.}\label{tab:amber-5ring}
    \makebox[\textwidth][c]{%
      \begin{tabular}{llrrrrrr}
        ...
        \midrule
implicit, partial & & & & & & \\
2--cyclopentanylindole & 7--cyclopentanylindole &  4.194 &  &  3.833 &  &  0.361 & 0.032 \\
7--cyclopentanylindole & 2--cyclopentanylindole & -4.300 &  & -3.964 &  &   -0.335 & 0.045\\
\\
implicit, full & & & & & & \\
2--cyclopentanylindole & 7--cyclopentanylindole &  4.286 &  &  3.921 &  & 0.365  & 0.069 \\
7--cyclopentanylindole & 2--cyclopentanylindole & -4.418 &  & -4.098 &  & -0.320 & 0.036 \\
\\
explicit, partial & & & & & \\
2--cyclopentanylindole & 7--cyclopentanylindole &  4.145 &  &  3.517 &  & 0.628 & 0.059 \\
7--cyclopentanylindole & 2--cyclopentanylindole & -4.256 &  & -3.759 &  & -0.497 & 0.032 \\
\\
        \bottomrule
      \end{tabular}
    }
