...
This was the case despite our best efforts to maintain a consistent protocol across codes; for example, the codes compared nominally use the same functional form of soft core potentials, and implementations of many other algorithms which should be the same or are thought to be equivalent.
