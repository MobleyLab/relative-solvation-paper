...
% HHL: You should mention here if this is possible with Gromacs and how.  If
%      that requires some scripting then just say so.  I would think
%      setting constraint=none and explicitly defining the wanted constraints
%      in the topology file should work too.
