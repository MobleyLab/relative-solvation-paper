...
cycles~\cite{Tembe1984281}.  As the free energy is a state function, the sum of 
free energy changes computed around any closed cycle must be zero.  This also 
implies that the reversible work can be computed arbitrarily along
...
default friction coefficient of \SI{1.0}{ps/m_{atom}}.  Absolute hydration 
...
simulations.  In this work we primarily focus on thermodynamic integration (TI) 
as this is supported by all MD packages ``out--of--the--box'' and gives good 
results provided the $\lambda$ spacing is sufficiently narrow in rapidly 
varying parts of the gradient~\cite{JCC:JCC23229}.  Equation~\ref{eq:ti} 
computes the free energy as
