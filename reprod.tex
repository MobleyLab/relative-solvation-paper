...
of thermodynamic cycles.  As the free energy is a state function, the sum of free energy changes
...
free energies computed from AFE simulation, FreeSolv, has been
...
careful construction of topologies by keeping force field parameters constant 
in the files.

\paragraph{CHARMM} The PERT module duplicates the topology similar to
sander but the data structures for mapped atoms are present only once.  The 
...
was carried out i.e.\ RAFE MD simulations started with new velocties for the 
...
hydrogens (TIP3P) were constraint with SHAKE but none of the atoms in the 
perturbed group and so the time step was set to \SI{1}{fs} (see Sire protocol 
below for an alternative approach).  Temperature was controlled through a 
...
Differently from water phase simulations, he reaction field was not employed in vacuum
...
backward direction so in total 6 simulations per mutation pair.  The
...
\begin{table}[]
  ...
  \begin{tabular}{llrrrr}
    ...
    \midrule
ethane & methane & 0.02 $\pm$ 0.01 & -0.13 $\pm$ 0.02 &
\multirow{2}{*}{-0.02 $\pm$ 0.01} & \\
methane & ethane & 0.00 $\pm$ 0.03 & -0.19 $\pm$ 0.03 & & \\
methanol & methane & 6.19 $\pm$ 0.01 & 6.20 $\pm$ 0.02 & 
\multirow{2}{*}{6.20 $\pm$ 0.01} \\
methane & methanol & 6.20 $\pm$ 0.03 & -6.15 $\pm$ 0.01 & & \\
ethane  & methanol & -6.20 $\pm$ 0.01 & -6.27 $\pm$ 0.01 &
\multirow{2}{*}{-6.22 $\pm$ 0.01} & -6.20 \\
methanol & ethane & -6.20 $\pm$ 0.01 & -6.25 $\pm$ 0.01 & & \\
toluene & methane & 3.24 $\pm$ 0.02 & 3.39 $\pm$ 0.02 &
\multirow{2}{*}{3.19 $\pm$ 0.01} & 3.29 \\
methane & toluene & 3.42 $\pm$ 0.03 & 3.52 $\pm$ 0.03 & & \\
neopentane\footnote{\label{foot:cent}central mapping.} & methane & 0.32 $\pm$ 
0.04 & -0.03 $\pm$ 0.06 & \multirow{4}{*}{-0.13 $\pm$ 0.02} & 0.37 \\
methane\footref{foot:cent} & neopentane & 0.25 $\pm$ 0.03 & -0.07 $\pm$ 
0.03 & & \\
neopentane\footnote{\label{foot:term}terminal mapping.} & methane & -0.13 
$\pm$ 0.01 & -0.12 $\pm$ 0.02 & & \\
methane\footref{foot:term} & neopentane & -0.13 $\pm$ 0.03 & -0.12 $\pm$ 
0.03 & & \\
2-methylfuran  & methane & 3.09 $\pm$ 0.01 & 3.10 $\pm$ 0.01 &
\multirow{2}{*}{2.96 $\pm$ 0.02} \\
methane & 2-methyfuran  & 3.10 $\pm$ 0.03 & 3.15 $\pm$ 0.03 & & \\
2-methylindole & methane & 8.78 $\pm$ 0.03 & 8.78 $\pm$ 0.04 &
\multirow{2}{*}{8.72 $\pm$ 0.01} \\
methane & 2-methylindole & 9.14 $\pm$ 0.02 & 9.13 $\pm$ 0.03 & \\
...
7--cyclopentanylindole & 0.36 $\pm$ 0.03 & 0.63 $\pm$ 0.06 & 
\multirow{2}{*}{0.39 $\pm$ 0.04} \\
7--cyclopentanylindole\footref{foot:partial} & 2--cyclopentanylindole & 0.34 
$\pm$ 0.05 & 0.50 $\pm$ 0.03 & & \\
    \bottomrule
  \end{tabular}
}
  \end{minipage}
...
As regards reaction field methods, Sire/SOMD implements a Barker Watts reaction field (BWRF) with atom-based cutoff, as explained in subsection~\ref{sec:rafe_protocols} , while Gromacs adopts a BWRF with charge-group cutoff. Although this technical differences, consistency between Sire/SOMD  and Gromacs RF is present, with a MUE=\SI{0.18}{kcal.mol^{-1}}.
However, methane to neopentane transformation is still matter of problems. In this case, Sire/SOMD is able to maintain consistency between central and terminal mapping, as shown in tab~\ref{S-tab:sire-finalresults}, while Gromacs RF has $\Delta\Delta$G=\SI{-0.20 +- 0.01}{kcal.mol^{-1}} for centrally mapped transformation and $\Delta\Delta$G=\SI{-0.05 +- 0.02}{kcal.mol^{-1}} for terminally mapped.
As regards PME methods, Sire/SOMD presents a MUE=\SI{0.18}{kcal.mol^{-1}} and MUE=\SI{0.23}{kcal.mol^{-1}} with Gromacs PME and Amber respectively, achieving a very good agreement between $\Delta\Delta$G predictions. 
(NB it may be good to say somewhere how much was the MUE with the initial standard protocol)
(NB Gromacs RF in vacuum uses a dielectric of 1.0, this caused problem to Sire vacuum simulations instead)

Overall, the Sire/SOMD free energy estimations are in good agreement with all the other codes, as the MUE suggests. Reproducibility was attained between reaction field and PME methods. In particular, the unperturbed hydrogen bonds constraint allows a timestep of \SI{2}{fs} and all the Sire/SOMD simulations can be carried out in one single step, with a single-topology paradigm, differently from multi-step approaches used in Amber, Gromacs and CHARMM.
