...
to a molecule and determining how it is coupled to the rest of the system.
 %What about them? It defines what molecule to be coupled/decoupled, right? So if it defines something about the initial and final states you're going to have to say what you mean by that.
%[GDRM] changed
...
\todo{we speculate it is an soft-core coulomb issue, but I'm not confident enough to write it down before I run some gaff1.8 simulations using soft-core coulomb in the split protocol. In this way it will be possible to compare electrostatic components of $\Delta G_{A\rightarrow B}$.}
