...
atoms only determined from atoms having zero vdW parameters.
...
SOMD from the Sire 2016.1 release ~\cite{Sire,eastman2012openmm}.
...
simulations with a cutoff of \SI{10}{\angstrom}. A similar cutoff was used for Lennard-Jones interactions.
%%SB: I checked the latest simulations run and dielectric constant was kept at 78.3 (default value)
%% I think this is in line with all the other codes, too
...
A very good agreement is observed between both methodologies ($R^2$=\SI{0.99+/-0.01}{} and 
