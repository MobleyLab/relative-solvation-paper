...
lengths, respectively.  Although for small bond lengths change this error may 
be negligible, it becomes pivotal for perturbations of  hydrogen atoms to 
carbon, nitrogen or oxygen, where the bond length changes of several tenth of 
Angstrom.
% halx: please quantify

After the implementation of the our new constraint scheme, a comparison with no 
constraints simulations has been run. Figure~\ref{S-fig:sire_constraints} shows 
