...
\begin{abstract}
  Alchemical free energy calculation is a very important branch of modern 
  simulation techniques.  Contemporary Molecular Dynamics and Monte Carlo 
  ...
  than its absolute counterpart.  However, relative transformations promise to 
  be computationally and statistically more efficient.  Here we present the 
  results for relative hydration free energies (RAFE) for a set of small 
  organic molecules and show that free energies can be satisfactorily 
  reproduced with aforementioned codes.  We will also recommend simulation 
  protocols, setup procedures and analysis techniques, and we discuss what 
  needs to be done to progress the field.
\end{abstract}
...
package or are the same, like pressure and temperature scaling,
...
presented recently~\cite{doi:10.1021/acs.jced.7b00104}. Here, we are interested 
...
obtained with these packages as well as making recommendations
