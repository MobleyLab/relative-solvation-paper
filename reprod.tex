...
\begin{abstract}
  ...
  organic molecules and demonstrate that free energies can be reproduced to within 0.2-0.3 kcal/mol with aforementioned codes. Achieving this level of reproducibility requires however attention to details and package-specific simulation protocols. The benchmarks and protocols reported here should be useful for the community to validate new and future versions of free energy calculations software.
\end{abstract}
...
molecule (7-CPI) with the AMBER result less negative than with the other MD packages by higher by 0.4--\SI{0.8}{kcal.mol^{-1}}. This particular discrepancy does not correlate with significant variations in density between AMBER and other codes. 
...
The free energies we have computed appear to be in reasonable good agreement with each other (see Tables~\ref{tab:absolute2} and \ref{tab:relative}).  The MAE is \SI{0.2}{kcal/mol} for absolute free energies and \SI{0.3}{kcal/mol} for 
