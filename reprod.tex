...
In the SI we show various plots of the free energy derivative versus lambda to demonstrate this.
...
CHARMM for alchemical free energy calculation (AFE) has been widely used with the PERT module, but few bugs not previously reported in CHARMM c40b1 were found and careful AFE setup is needed to produce robust and accurate results. Bugs regarding TI gradient accumulation in the parallel version were identified and fixed by Dr. Stefan Boresch.
