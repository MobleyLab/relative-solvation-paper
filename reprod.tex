...
from the electrostatic and bonded components; (ii) in a single topology approach that changed 
bonded, van der Waals, and electrostatic terms simultaneously;  and (iii) via the difference 
...
Absolute hydration free energies were calculated using a protocol used in previous works [refs]%\cite{newFreeSolvPaper}.
...
Waals, and bonded terms were modified together.
...
\todo{make a compact $\partial \mathrm{H}/\partial\lambda$ plot}
...
if used naively. Additionally, analysis of the results depends on understanding how these 
features are used because 
they can be a source of errors if misused. Specifically, \texttt{couple-moltype} implicitly defines the 
initial and final states. %What about them? It defines what molecule to be coupled/decoupled, right? So if it defines something about the 
%initial and final states you're going to have to say what you mean by that.
 It should be used in absolute free energy calculations to tag the 
molecule that will be decoupled from the rest of the system. \texttt{couple-moltype} should 
not be used in relative transformations in GROMACS. %because why? "... because relative calculations rely on turning off interactions between only part of a molecule and the rest of the system, not the entire molecule, so use of this option is inappropriate for relative calculations (though this is not well documented)."
 \texttt{couple-lambda0} and 
\texttt{couple-lambda1} define which of the \textbf{tagged} molecule's non-bonded parameters  %what is a tagged molecule?
are present in the initial and in the final state, respectively.  In absolute free energy 
...
In relative free energy calculations, however, they should be avoided. %What does it mean to avoid them? Why?
\texttt{couple-intramol} 
specifies if you want to modify intramolecular interactions along the alchemical 
...
because these are easily calculated with considerable precision [refs] and are considerably simpler to
set up and implement than relative calculations.
Prior work actually compared calculated absolute hydration free energies across different codes with considerable success [ref 10.1007/s10822-010-9343-7, see Fig 7], further supporting this view.
Thus, we compared relative free 
energies calculated via simultaneous parameter change simulations -- our ``unified protocol'' -- 
...
component are subject to very large electrostatic forces that compromise the simulation.  %Compromise how? Is this the "nuclear fusion" type problem previously noted? I think this is discussed on Alchemistry/in the literature, probably should be cited? 
Thus we find that for stable and effective relative free energy calculations, particle deletion processes
require electrostatic terms to be turned off before van de Waals and bonded parameters are removed/modified. Insertion processes, in their turn, demand bonded and van der Waals parameters to be changed before charges are turned on.
...
\hline
 &  & \multicolumn{4}{c}{Absolute \footnote{\label{foot:abs}results obtained from absolute free energy calculations.}} & \multicolumn{4}{c}{Split \footnote{\label{foot:split} results obtained from alchemical transformations with vdW scaling separate from scaling of electrostatic and bonded terms.}} & \multicolumn{4}{c}{Unified \footnote{\label{foot:uni} results obtained from alchemical transformations with all parameters scaled together.}} \\
 &  & \multicolumn{2}{c}{GROMACS (RF)} & \multicolumn{2}{c}{GROMACS (PME)} & \multicolumn{2}{c}{GROMACS (RF)} & \multicolumn{2}{c}{GROMACS (PME)} & \multicolumn{2}{c}{GROMACS (RF)} & \multicolumn{2}{c}{GROMACS (PME)} \\
\multicolumn{2}{c}{Transformations} & $\Delta \Delta G$ & SEM & $\Delta \Delta G$ & SEM & $\Delta \Delta G$ & SEM & $\Delta \Delta G$ & SEM & $\Delta \Delta G$ & SEM & $\Delta \Delta G$ & SEM \\ \hline
methane & ethane & 0.059 & 0.012 & 0.036 & 0.009 & -0.199 & 0.015 & -0.183 & 0.007 & -0.187 & 0.018 & -0.165 & 0.011 \\
ethane & methane & -0.059 & 0.012 & -0.036 & 0.009 & 0.188 & 0.018 & 0.178 & 0.019 & 0.248 & 0.003 & 0.236 & 0.002 \\
ethane & methanol & -5.829 & 0.012 & -5.983 & 0.008 & -6.046 & 0.008 & -6.107 & 0.006 & -7.038 & 0.005 & -7.134 & 0.018 \\
methanol & ethane & 5.829 & 0.012 & 5.983 & 0.008 & 6.047 & 0.003 & 6.116 & 0.002 & 7.252 & 0.008 & 7.324 & 0.007 \\
methane & methanol & -5.77 & 0.01 & -5.947 & 0.009 & -6.212 & 0.047 & -6.243 & 0.047 & -7.205 & 0.019 & -7.289 & 0.019 \\
methanol & methane & 5.77 & 0.01 & 5.947 & 0.009 & 6.388 & 0.007 & 6.422 & 0.005 & 7.530 & 0.018 & 7.611 & 0.010 \\
methane & 2-methylfuran & -2.867 & 0.01 & -2.95 & 0.01 & -3.125 & 0.008 & -3.080 & 0.013 & -3.143 & 0.006 & -3.102 & 0.011 \\
2-methylfuran & methane & 2.867 & 0.01 & 2.95 & 0.01 & 3.084 & 0.008 & 3.028 & 0.008 & 3.144 & 0.014 & 3.087 & 0.013 \\
methane & toluene & -2.969 & 0.011 & -3.159 & 0.011 & -3.246 & 0.011 & -3.204 & 0.012 & -3.328 & 0.013 & -3.310 & 0.010 \\
toluene & methane & 2.969 & 0.011 & 3.159 & 0.011 & 3.268 & 0.026 & 3.259 & 0.023 & 3.303 & 0.009 & 3.292 & 0.010 \\
methane & 2-methylindole & -8.438 & 0.017 & -8.793 & 0.015 & -8.789 & 0.031 & -8.797 & 0.010 & -8.670 & 0.027 & -8.732 & 0.043 \\
2-methylindole & methane & 8.438 & 0.017 & 8.793 & 0.015 & 8.744 & 0.020 & 8.764 & 0.030 & 8.756 & 0.014 & 8.834 & 0.026 \\
methane & neopentane\footnote{\label{foot:cent}central mapping.} & 0.181 & 0.012 & 0.135 & 0.009 & -0.207 & 0.018 & -0.154 & 0.047 & -0.239 & 0.014 & -0.076 & 0.011 \\
neopentane & methane\footref{foot:cent} & -0.181 & 0.012 & -0.135 & 0.009 & 0.359 & 0.021 & 0.309 & 0.026 & 0.294 & 0.021 & 0.218 & 0.034 \\
methane & neopentane\footnote{\label{foot:term}terminal mapping.} & 0.181 & 0.012 & 0.135 & 0.009 & -0.053 & 0.024 & 0.036 & 0.017 & -0.025 & 0.010 & 0.036 & 0.017 \\
neopentane2 & methane\footref{foot:term} & -0.181 & 0.012 & -0.135 & 0.009 & -0.027 & 0.007 & -0.043 & 0.012 & -0.049 & 0.011 & -0.069 & 0.012 \\
2-cyclopentanylindole & 7-cyclopentanylindole & -0.018 & 0.05 & 0.019 & 0.023 & -0.067 & 0.022 & -0.031 & 0.028 & -0.094 & 0.052 & -0.135 & 0.103 \\
7-cyclopentanylindole & 2-cyclopentanylindole & 0.018 & 0.05 & -0.019 & 0.023 & 0.119 & 0.057 & 0.204 & 0.043 & 0.117 & 0.077 & 0.220 & 0.102 \\ \hline
\end{tabular}
}
\end{sidewaystable}
...
an adapted split protocol. The simulation is divided into two stages: a deletion and 
an insertion stage. For the sake of optimizing computational resources used, the deletion 
step transforms a molecular branch into a dummy branch while turning on the Lennard-
Jones parameters of the new molecular piece in 31 windows. This modification 
allows a smaller insertion step of 16 windows.
...
Particle Mesh Ewald or Reaction Field 
for calculation of long-range electrostatic interactions. 
