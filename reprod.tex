...
%%JM: SOME CITATIONS: COPERNICUS, BAC, STAGGE,FESETUP,ExTASY..
...
%%JM: Stefano please describe the protocols used to compute the absolute hydration 
%% free energies. Be clear on constraints and time-steps.
...
instabilities in the free energy calculation.  We chose the 1--1--6 softcore 
...
%%JM: Stefano do update the tables to follow HLL convention 'Signs of the 
%%  backward transformation have been reverted to correspond to the forward 
%%  transformation.''

Figure ~\ref{fig:sire_histogram} compares relative free energy of hydration 
$\Delta\Delta G$  according to the 'unperturbed H bond' protocol, with 
relative $\Delta\Delta G$ obtained from two absolute free energy calculations,
A very good agreement is observed between both methodologies ($R^2$=\SI{0.99+/-0.0X}{} and 
MAD=\SI{0.10+/-0.03}{kcal.mol^{-1}}), highlighting internal consistency within SOMD.
...
involving hydrogen atoms, thus enabling a time step of \SI{2}{fs), whilst giving 
...
solute at perturbed \lambda values is carried out using the coordinates of the 
reference \lambda trajectory. This leads to a neglect of contributions of the bonded
...
\begin{table}[]
  ...
  \begin{tabular}{lrrrr}
    \toprule
    Package & SOMD & Gromcs RF & GROMACS PME & AMBER\\
    \midrule
SOMD         & 0.00 & 0.18    & 0.18 & 0.23\\
...
\begin{table}[]
  ...
  \begin{tabular}{lcccc}
    ...
    \midrule
SOMD         & 0.02< 0.04< 0.05 & 0.17< 0.19< 0.21    & 0.16< 0.18< 0.20 & 0.21< 0.23< 0.25\\
