...
multitude of methods have been devised to make reversible work%%JM I like 'free 
%%energy changes' better
...
doi:10.1021/jp0217839, deng_computations_2009}.  Restraints between 
corresponding atoms, emulating the single topology approach, can be used to 
counter this without affecting the free energy~\cite{JCC:Axelsen-Li}.
Topological similarity can also be exploited in the dual topology approach when 
the charges of a common core are explicitly made equal, while the atoms are all 
of the same type, and thus need to be present only 
once~\cite{doi:10.1021/acs.jctc.5b00179}. This approach, however, shifts all 
the chemistry exclusively into the dummy atoms and is thus of only limited use.
...
constraints this can be a viable option~\cite{doi:10.1021/ct700081t,
  rocklin_separated_2013, JCC:Axelsen-Li}.
%%JM see also doi:10.1021/ct700081t
% HHL: that one is right there already :-)
