...
Sire/OpenMM 6.3 (revision 16.1). % HHL: citation?
...
simulations. % HHL: why 82?  For 298K this would be more like 78.
Furthermore, a cutoff of \SI{12}{\angstrom} was set for the non--bonded
interactions and periodic boundary conditions were imposed. % HHL: check box 
%sizes
...
Fig~\ref{fig:thermocycle}) as detailled in Ref.~\citenum{Bosisio2016}. The 
...
electrostatic % HHL: I guess 'nc' stands for no cutoff?
...
GROMACS simulations.
% HHL: change table entries as suggested by DLM and demonstrated in Table 1 
%(AMBER)
% HHL: order of transformations is not the same as in Table 1
\begin{sidewaystable}[]
  \centering
  ...
  \toprule
   &  & \multicolumn{2}{l}{Split \footnote{\label{foot:split} results obtained from alchemical transformations with electrostatic and bonded scaling separate from    vdW parameter change.}} & \multicolumn{2}{l}{Unified \footnote{\label{foot:uni} results obtained from alchemical transformation with all parameters scaling together.}} & \multicolumn{2}{l}{Absolute \footnote{\label{foot:abs}results obtained from absolute free energy calculations.}} \\
...
ethane & methane & -0.025 $\pm$ 0.005 & -0.035 $\pm$ 0.02 & -0.017 $\pm$ 0.003 & 0.236 $\pm$ 0.002 & \multicolumn{2}{l}{\multirow{2}{*}{-0.06 $\pm$ 0.01}} \\
methane & ethane & -0.01 $\pm$ 0.02 & -0.02 $\pm$ 0.01 & 0.046 $\pm$ 0.02 \footnote{\label{foot:inv} inverted sign} & 0.17 $\pm$ 0.01 & \multicolumn{2}{l}{} \\
methanol & methane & 6.163 $\pm$ 0.006 & 6.197 $\pm$ 0.004 & 7.30 $\pm$ 0.02 & 7.61 $\pm$ 0.01 & \multicolumn{2}{l}{\multirow{2}{*}{5.77 $\pm$ 0.01}} \\
methane & methanol & 6.168 $\pm$ 0.005 & 6.199 $\pm$ 0.008 & 7.09 $\pm$ 0.02 & 7.29 $\pm$ 0.02 & \multicolumn{2}{l}{} \\
ethane & methanol & -6.123 $\pm$ 0.007 & -6.185 $\pm$ 0.006 & -7.117 $\pm$ 0.005 & -7.13 $\pm$ 0.02 & \multicolumn{2}{l}{\multirow{2}{*}{-5.83 $\pm$ 0.01}} \\
methanol & ethane & -6.124 $\pm$ 0.005 & -6.193$\pm$ 0.004 & -7.338 $\pm$ 0.004 & -7.32 $\pm$ 0.01 & \multicolumn{2}{l}{} \\
...
% HHL: we have discussed this a while ago: you will need to adjust lambda
%spacing in the rapidly varying part of the dH/dl region.  A quick look at the 
%dH/dl curve will make this clear immediately which probably means adding a 
%figure to the SI.  This is not a problem with BAR/MBAR.
...
% HHL: we don't know yet what the best protocol is, you need to discuss this 
%       first
