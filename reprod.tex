...
%      places.
% GDRM: footnote d was meant to avoid confusion. In a first glance, 
% some values might seem not to be in the convention that we adopted.
...
% GDRM: yes, it has the absolute values.  The protocol is unified
\begin{table}[]
\centering
...
%      here?
% GDRM: There was none. It was my mistake.
...
% GDRM: perhaps it can, if we define a new atom type for the hydrogens that
%      will be alchemically changed.
