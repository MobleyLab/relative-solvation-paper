...
\begin{table}[]
  \begin{minipage}{\linewidth}
    \caption{MUE with 95$\%$ confidence interval between Sire/SOMD, GROMACS 
    with 
    ...
    \makebox[\textwidth][c]{
      \begin{tabular}{lcccc}
        ...
        Package & Sire/SOMD & Gromcs RF & GROMACS PME & AMBER\\
        \midrule
        Sire/SOMD         & 0.02< 0.04< 0.05 & 0.17< 0.19< 0.21    & 0.16< 
        0.18< 0.20 & 0.21< 0.23< 0.25\\
...
free energy calculations. Running the simulations depends on understanding how these 
...
% GDRM: Alright. I'll make it more explicit. 
...
a set of 31 zeros.
Unified protocols have all \inpopt{-lambdas} entries equal to the set (\inpopt{0.0, 0.05, 
...
\ref{fig:ti-fep}. This effect was observed in solution simulations.
...
% HHL: remove table tab:sire-table because data is in tab:relative
