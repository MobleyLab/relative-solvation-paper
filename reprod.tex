...
in section~\ref{S-sec:separated} of the SI.  The scaling of the bonded terms 
...
\begin{table}[]
  \begin{minipage}{\linewidth}
    \caption{Comparing free energies of hydration for various MD packages as 
    obtained from absolute transformations.}\label{tab:absolute}
    \makebox[\textwidth][c]{
      \begin{tabular}{llrrrr}
        \toprule
        \multicolumn{2}{l}{transformation} & AMBER & CHARMM & GROMACS & SOMD 
        \\
        \midrule
        ethane & methane & \num{-0.02+-0.01} & & & \\
        methanol & methane & \num{6.20+-0.01} & & & \\
