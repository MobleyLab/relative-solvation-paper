...
% HHL: mention that CHARMM does not support force switching for LJ with %   
%      softcore but which is nowa fixed part of the CHARMM force fields 
%     (Stefand Boresch: ``this is the actual elephant in the room''.)
